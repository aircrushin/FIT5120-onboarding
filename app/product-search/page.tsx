...
const DropdownFilterTabs = ({ filterOptions, activeFilters, onFiltersChange, isLoading, onClearFilters }: FilterPanelProps) => {
  ...
  return (
    <div className="w-full mb-6">
      {/* Filter Tabs */}
      <div className="flex flex-wrap w-full justify-center gap-3 filter-dropdown-container">
        {/* Safety Level Filter */}
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="relative mb-8 z-30">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="relative transition-all duration-300 flex flex-col w-full justify-center">
